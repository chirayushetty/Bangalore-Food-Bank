...
export const BreakfastFeeding = () => {
  ...
  <div class="carousel-inner" data-interval="1500" style={style}>
    <div class="carousel-item active">
      <img class="d-block w-100" src="http://bangalorefoodbank.com/images/gallery/School-breakfast-feeding-program/2.jpg" alt="Second slide"/>
    </div>
...
<p>
 ...
 <li>Relief to parents & guardians</li>
    ...
    <a class="btn btn-secondary btn-lg" style={{fontSize: "24px"}} href="#" role="button" >Donate Now!</a>
    </p>
    <p style={{textAlign: "center"}}>
    <a class="btn btn-secondary btn-lg" style={{fontSize: "24px"}} href="#" role="button" Link to="/PastAchievements">View Past Achievements</a>
    </p>
    </div>
  )
}
